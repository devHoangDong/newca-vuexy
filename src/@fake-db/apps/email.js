...
let data = {
  emails: [
    {
      id: 1,
      sender: "hoangninh@mail.com",
      sender_name: "Hoàng Ninh",
      to: ["johndoe@mail.com"],
      img: require("../../assets/img/portrait/small/avatar-s-1.jpg").default,
      subject: "[NewCA] Lỗi token chữ ký số NewCA",
      cc: [],
      bcc: [],
      message: `Token của tôi bị lỗi không sử dụng được`,
    ...
    },
    {
      ...
      sender_name: "Nhân viên NewCA",
      to: ["johndoe@mail.com"],
      img: require("../../assets/img/portrait/small/avatar-s-2.jpg").default,
      subject: "[NewCA] Lỗi token chữ ký số NewCA",
      cc: ["vrushankbrahmshatriya@mail.com"],
      bcc: ["menka@mail.com"],
      message: `Kính gửi anh Hoàng Ninh...`,
    ...
    },
    {
      ...
      cc: [],
      bcc: [],
      message: `Token của tôi vẫn chưa hoạt động được`,
      isStarred: false,
      labels: ["company"],
      time: "08:35:00",
      day: "Jul 30",
    ...
    },
    {
      ...
      to: ["johndoe@mail.com"],
      img: require("../../assets/img/portrait/small/avatar-s-4.jpg").default,
      subject: "Ui Related",
      cc: [],
      bcc: [],
    ...
    },
    {
      ...
      to: ["johndoe@dot.gov"],
      img: require("../../assets/img/portrait/small/avatar-s-11.jpg").default,
    ...
    },
    {
      ...
      img: require("../../assets/img/portrait/small/avatar-s-6.jpg").default,
    ...
    },
    {
      ...
      img: require("../../assets/img/portrait/small/avatar-s-13.jpg").default,
    ...
    },
    {
      ...
      img: require("../../assets/img/portrait/small/avatar-s-18.jpg").default,
    ...
    },
    {
      ...
      img: require("../../assets/img/portrait/small/avatar-s-14.jpg").default,
    ...
    },
    {
      ...
      sender_name: "Eb Begg",
      to: ["johndoe@51.la"],
      img: require("../../assets/img/portrait/small/avatar-s-19.jpg").default,
    ...
    },
    {
      ...
      img: require("../../assets/img/portrait/small/avatar-s-9.jpg").default,
...
// Get Mails
mock
  .onGet("/api/email/mails")
  .reply(200, JSON.parse(JSON.stringify(data.emails)));
